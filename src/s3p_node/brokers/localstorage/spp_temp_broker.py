...
class SppTempBroker:
    ...
    def __init__(self, ref: S3PRefer, local_path: str):
        self.__ref = ref
    ...
    def rename(self, document: S3PDocument, name: str = ''):
